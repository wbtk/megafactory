...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'admin', description: 'Символьный код роли' }),
    (0, class_validator_1.IsString)({ message: 'Должно быть строкой' }),
    __metadata("design:type", String)
], CreateRoleDto.prototype, "\u0441ode", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Пользователь без ограничений в правах', description: 'Описание роли' }),
    (0, class_validator_1.IsString)({ message: 'Должно быть строкой' }),
    __metadata("design:type", String)
