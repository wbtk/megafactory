...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: 'Собственная организация' }),
    (0, class_validator_1.IsNumber)({}, { message: 'Должно быть числом' }),
    __metadata("design:type", Number)
], CreateOrganizationDto.prototype, "own", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, swagger_1.ApiProperty)({ example: 22323550090, description: 'ИНН' }),
    (0, class_validator_1.IsNumber)({}, { message: 'Должно быть числом' }),
    __metadata("design:type", Number)
