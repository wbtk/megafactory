...
const PermissionDocumentTypeGuard = (type) => {
        ...
        async canActivate(context) {
            ...
            try {
                ...
                for (const key in permissions_type_1.default) {
                    if (Object.prototype.hasOwnProperty.call(permissions_type_1.default, key)) {
                        if (permissions_type_1.default[key] === type) {
                            permissionKey = key;
                        }
                    }
                }
...
exports.default = PermissionDocumentTypeGuard;
//# sourceMappingURL=document-type.guard.js.map